...
function RandomGenerator() {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center p-4 md:p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <div className="flex gap-4">
                ...
                >
                  <div className={`w-2 h-2 rounded-full ${contentType === "movie" ? "bg-white" : "bg-gray-500"}`}></div>
                  <span>Movies</span>
                </button>
                <button
                  onClick={() => {
